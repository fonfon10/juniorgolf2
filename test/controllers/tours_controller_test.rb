...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { country: @tour.country, name: @tour.name, province: @tour.province } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { country: @tour.country, name: @tour.name, province: @tour.province } }
